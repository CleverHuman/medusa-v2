...
export default {
  ...
  methods: {
    ...
    cancelAuthUser(row) {
      ...
      this.$modal.confirm('Are you sure you want to cancel the role for user "' + row.userName + '"?').then(function() {
    ...
    cancelAuthUserAll(row) {
      ...
      this.$modal.confirm('Are you sure you want to cancel authorization for selected users?').then(function() {
