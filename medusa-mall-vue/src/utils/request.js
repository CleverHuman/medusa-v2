...
const service = axios.create({
  ...
  baseURL: process.env.VUE_APP_BASE_API+"/api/mall",
  // 超时
  timeout: 10000
})
...
service.interceptors.response.use(res => {
    ...
    if (code === 401) {
      if (!isRelogin.show) {
        isRelogin.show = true;
        MessageBox.confirm('Your login status has expired.', 'System prompts', { confirmButtonText: 'Re-login', cancelButtonText: 'cancel', type: 'warning' }).then(() => {
